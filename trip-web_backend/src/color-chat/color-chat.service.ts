...
export class ColorChatService {
  ...
  async sendMessage(chatRequestDto: ChatRequestDto): Promise<string> {
    try {
      ...
      console.log('타입', personality_types);
      ...
      // const request_message = `Through the question below, the color that best matches the user and the explanation accordingly are provided.
      // Output Rules: The output shall be in accordance with what is included in the brackets below.
      // The contents in brackets are never directly output, but are interpreted and outputted.
      // The interpretation must not directly mention the answers to the questions, and should primarily refer to the color.
      // All metaphors are printed in the form of subheadings.
      // Translate sentences outside the curly braces literally without interpreting the meaning.
      // The name representing the color must consist of two words.
      // The description of the color minimizes the mention of the answer.
      // It is printed in Korean.
      // Based on the questions and answers below, create a color that best matches the user, a Hex value, and a similar color
      // Question 1: Tell me your name or nickname : ${nickname},
      // Question 2: Please tell me your age: ${age},
      // Question 3: When is your favorite season?: ${season_type},
      // Question 4: Choose 3 words that best describe your personality: ${personality_types[0]}, ${personality_types[1]}, ${personality_types[2]},
      // Question 5: What are your top priorities for making decisions?: ${decision_criteria_type},
      // Question 6: What do you think is the most important thing when you go on a trip?: ${travel_type},
      // Question 7: When do you feel the happiest in your daily life?: ${routine_best_happy},
      // Question 8: What is the first thing you check when you turn on your smartphone in the morning?: ${morning_phone_hobby_first_check},
      // Question 9: What is your favorite hobby?: ${favorite_hobby} -
